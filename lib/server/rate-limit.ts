 ...
 *
 * All rate limiting uses Supabase Postgres (DbRateLimiter) so no third-party
 * vendor without a BAA ever receives request metadata.
 */
...
// ── Supabase Postgres-backed limiter instances (multi-instance safe, HIPAA-safe) ─
