...
**Database:** `postgres`
**Inspected at:** 2026-06-06
**Scope:** Schema metadata only. No row data was read.

The cloud database currently exposes **59 public base tables**. The ERD below is generated from live table, column, primary-key, unique-key, nullability, and foreign-key metadata.
