...
// ── English ───────────────────────────────────────────────────────────────────
//
// Copy policy: no specific dollar or population claims without a verifiable source.
// The one statistic kept (statLabels[3] / STATS_CONFIG[3]): ~700,000 MA residents in the
// "SNAP Gap" (likely SNAP-eligible MassHealth members not enrolled):
...
const EN: LandingCopy = {
  ...
  heroDesc: "Massachusetts residents miss thousands in annual benefits because the system is too complex. HealthCompass MA checks 11+ programs at once and guides you through every application — for free.",
  heroTags: ["Free to use", "11+ programs", "6 languages", "Voice messaging", "~15 min to apply"],
  btnCheckEligibility: "Check My Eligibility",
  btnStartApplication: "Start Application",
  previewAnalyzing: "Analyzing your eligibility…",
  previewResult: "🎉 4 programs found — benefits worth thousands per year",
  ...
  problemItems: [
    ...
    { title: "Benefits slip through the cracks", body: "Eligible families often qualify for multiple programs worth thousands per year — but many never receive them, not because they don't qualify, but because they never knew to apply." },
    { title: "Wrongly denied? Most people don't fight back", body: "Benefits get denied or cut off over paperwork errors, missed deadlines, or misapplied rules — but appealing feels like a legal maze, so most people accept the denial instead of challenging it." },
  ],
  howLabel: "How It Works",
  howTitle: "From confusion to coverage in 5 steps",
  howDesc: "We eliminate the guesswork at every stage — from figuring out what you qualify for, to submitting applications, tracking outcomes, and appealing denials.",
  steps: [
    ...
    { title: "Got denied? Appeal in minutes", body: "If a program says no, paste the denial notice — our AI drafts a cited appeal letter grounded in real MassHealth regulations." },
  ],
  whyLabel: "Why HealthCompass MA",
  whyTitle: "Built for real Massachusetts families — now with more ways to get help",
  whyDesc: "Recent upgrades add live social worker chat, voice messaging, automatic translation, AI appeal support, a plain-language benefits glossary, and a full insurance history timeline — all designed to help eligible residents get the benefits they're entitled to with less friction.",
  featureItems: [
    { title: "AI Eligibility Engine", body: "Cross-check your profile against 11+ state and federal programs in seconds — no paperwork required." },
    ...
    { title: "Benefits Glossary", body: "Tap any confusing term — MAGI, spend-down, redetermination — for a plain-language definition in your own language." },
    { title: "Insurance History Timeline", body: "See your full coverage history in one view, with plain-language explanations of why your plan changed year to year." },
  ],
  statLabels: ["Benefit programs checked", "Languages supported", "Average time to apply", "MA residents likely missing SNAP"],
  ...
  ctaDesc: "It takes 15 minutes. It's completely free. Eligible families may qualify for multiple programs worth thousands per year, depending on household size and income.",
...
const ES: LandingCopy = {
  ...
  heroDesc: "Los residentes de Massachusetts pierden miles de dólares en beneficios anuales porque el sistema es demasiado complejo. HealthCompass MA verifica más de 11 programas a la vez y te guía en cada solicitud — gratis.",
  heroTags: ["Gratis", "11+ programas", "6 idiomas", "Mensajes de voz", "~15 min para solicitar"],
  ...
  previewResult: "🎉 4 programas encontrados — beneficios que valen miles al año",
  ...
  problemItems: [
    ...
    { title: "Los beneficios se pierden", body: "Las familias elegibles a menudo califican para varios programas que valen miles de dólares al año — pero muchas nunca los reciben, no porque no califiquen, sino porque nunca supieron que podían solicitarlos." },
    { title: "¿Le negaron el beneficio? La mayoría no apela", body: "Los beneficios se niegan o se cortan por errores de papeleo, plazos vencidos o reglas mal aplicadas — pero apelar parece un laberinto legal, así que la mayoría acepta la negación en vez de impugnarla." },
  ],
  howLabel: "Cómo Funciona",
  howTitle: "De la confusión a la cobertura en 5 pasos",
  howDesc: "Eliminamos las suposiciones en cada etapa — desde determinar para qué calificas, hasta enviar solicitudes, rastrear resultados y apelar negaciones.",
  steps: [
    ...
    { title: "¿Te negaron? Apela en minutos", body: "Si un programa te niega, pega el aviso de negación — nuestra IA redacta una carta de apelación citada, basada en las regulaciones reales de MassHealth." },
  ],
  whyLabel: "Por Qué HealthCompass MA",
  whyTitle: "Creado para familias reales de Massachusetts — ahora con más formas de recibir ayuda",
  whyDesc: "Las mejoras recientes agregan chat en vivo con trabajadores sociales, mensajes de voz, traducción automática, apoyo con apelaciones mediante IA, un glosario de beneficios en lenguaje sencillo y una línea de tiempo completa de tu historial de seguro — todo diseñado para ayudar a los residentes elegibles a obtener los beneficios que les corresponden con menos fricción.",
  featureItems: [
    { title: "Motor de Elegibilidad con IA", body: "Verifica tu perfil con más de 11 programas estatales y federales en segundos — sin papeleo." },
    ...
    { title: "Glosario de Beneficios", body: "Toca cualquier término confuso — MAGI, spend-down, redeterminación — para una definición en lenguaje sencillo en tu propio idioma." },
    { title: "Línea de Tiempo del Historial de Seguro", body: "Ve todo tu historial de cobertura en un solo lugar, con explicaciones claras de por qué tu plan cambió de un año a otro." },
  ],
  statLabels: ["Programas de beneficios verificados", "Idiomas disponibles", "Tiempo promedio para solicitar", "Residentes de MA que probablemente pierden SNAP"],
  ...
  ctaDesc: "Toma 15 minutos. Es completamente gratis. Las familias elegibles pueden calificar para varios programas que valen miles de dólares al año, según el tamaño del hogar y los ingresos.",
...
const ZH_CN: LandingCopy = {
  ...
  heroH1Line1: "找到您应得的",
  heroH1Shimmer: "每一项福利",
  heroDesc: "马萨诸塞州居民因系统过于复杂而错过数千美元的年度福利。HealthCompass MA一次检查11个以上项目，并为您免费指导每一步申请。",
  heroTags: ["免费使用", "11+个项目", "6种语言", "语音消息", "~15分钟申请"],
  btnCheckEligibility: "检查我的资格",
  btnStartApplication: "开始申请",
  previewAnalyzing: "正在分析您的资格…",
  previewResult: "🎉 找到4个项目 — 每年价值数千美元的福利",
  ...
  problemItems: [
    ...
    { title: "福利从缝隙中溜走", body: "符合条件的家庭往往可同时符合多个项目的资格，每年价值数千美元 — 但许多家庭从未领取，不是因为不符合资格，而是因为他们从不知道可以申请。" },
    { title: "被错误拒绝？大多数人选择放弃申诉", body: "福利因文件错误、错过截止日期或规则误用而被拒绝或取消 — 但申诉像一个法律迷宫，所以大多数人选择接受拒绝，而不是挑战它。" },
  ],
  howLabel: "如何运作",
  howTitle: "5步从困惑到获得保障",
  howDesc: "我们消除了每个阶段的猜测 — 从弄清楚您有资格申请什么，到提交申请、跟踪结果，再到申诉被拒的情况。",
  steps: [
    ...
    { title: "被拒绝？几分钟内申诉", body: "如果项目拒绝了您，粘贴拒绝通知 — 我们的AI会起草一封基于真实MassHealth法规、附有引用的申诉信。" },
  ],
  whyLabel: "为何选择HealthCompass MA",
  whyTitle: "专为马萨诸塞州真实家庭打造 — 现在有更多获得帮助的方式",
  whyDesc: "最近的升级增加了真人社工聊天、语音消息、自动翻译、AI 上诉支持、通俗易懂的福利术语表，以及完整的保险历史时间线 — 全部都是为了帮助符合条件的居民更顺利地获得应得的福利。",
  featureItems: [
    { title: "AI资格引擎", body: "在几秒钟内将您的个人资料与11个以上的州和联邦项目进行交叉检查 — 无需文件。" },
    ...
    { title: "福利术语表", body: "点击任何令人困惑的术语 — 如MAGI、自付额、资格重新认定 — 即可获得您所用语言的通俗解释。" },
    { title: "保险历史时间线", body: "在一个页面查看您完整的保险覆盖历史，并附有关于您的计划为何逐年变化的通俗解释。" },
  ],
  statLabels: ["已检查福利项目", "支持的语言", "平均申请时间", "可能错过SNAP的马州居民"],
  ...
  ctaDesc: "只需15分钟。完全免费。符合条件的家庭可能有资格参加多个项目，每年价值数千美元，具体取决于家庭人数和收入。",
...
const HT: LandingCopy = {
  ...
  heroDesc: "Rezidan Massachusetts rate dè milye de dola nan benefis anyèl paske sistèm nan twò konplèks. HealthCompass MA tcheke 11+ pwogram alafwa epi gide ou nan chak aplikasyon — gratis.",
  heroTags: ["Gratis", "11+ pwogram", "6 lang", "Mesaj vwa", "~15 min pou aplike"],
  ...
  previewResult: "🎉 4 pwogram jwenn — benefis ki vo plizyè milye dola pa ane",
  ...
  problemItems: [
    ...
    { title: "Benefis glise nan fant yo", body: "Fanmi ki kalifye souvan kalifye pou plizyè pwogram ki vo plizyè milye dola pa ane — men anpil pa janm resevwa yo, se pa paske yo pa kalifye, men paske yo pa t janm konnen yo te kapab aplike." },
    { title: "Yo refize w mal? Pifò moun pa goumen tounen", body: "Benefis refize oswa koupe akoz erè nan papye, dat limit rate, oswa règ mal aplike — men fè apèl santi tankou yon labirent legal, kidonk pifò moun aksepte refi a olye yo konteste li." },
  ],
  howLabel: "Kijan Sa Travay",
  howTitle: "De konfizyon rive kouvèti nan 5 etap",
  howDesc: "Nou elimine devinen nan chak etap — de detèmine sa ou kalifye pou li, jiska soumèt aplikasyon, swiv rezilta, ak fè apèl kont refi.",
  steps: [
    ...
    { title: "Yo refize w? Fè apèl nan kèk minit", body: "Si yon pwogram refize w, kole avi refi a — AI nou an ekri yon lèt apèl ak sitasyon, baze sou règleman MassHealth reyèl." },
  ],
  whyLabel: "Poukisa HealthCompass MA",
  whyTitle: "Bati pou fanmi Massachusetts reyèl — kounye a ak plis fason pou jwenn èd",
  whyDesc: "Dènye amelyorasyon yo ajoute chat an dirèk ak travayè sosyal, mesaj vwa, tradiksyon otomatik, sipò apèl ak IA, yon glosè benefis nan lang klè, ak yon istorik konplè asirans ou — tout sa fèt pou ede rezidan ki kalifye jwenn avantaj yo gen dwa jwenn ak mwens difikilte.",
  featureItems: [
    { title: "Motè Kalifikasyon AI", body: "Tcheke pwofil ou kont 11+ pwogram leta ak federal an segonn — pa gen papye ki nesesè." },
    ...
    { title: "Glosè Benefis", body: "Tape nenpòt tèm ki twouble w — MAGI, spend-down, redetèminasyon — pou yon definisyon nan lang klè, nan pwòp lang ou." },
    { title: "Istorik Asirans", body: "Wè tout istorik kouvèti ou nan yon sèl kote, ak eksplikasyon klè poukisa plan ou chanje ane apre ane." },
  ],
  statLabels: ["Pwogram benefis tcheke", "Lang sipòte", "Tan mwayèn pou aplike", "Rezidan MA ki gen chans rate SNAP"],
  ...
  ctaDesc: "Sa pran 15 minit. Li totalman gratis. Fanmi ki kalifye ka kalifye pou plizyè pwogram ki vo plizyè milye dola pa ane, selon gwosè kay la ak revni.",
...
const PT_BR: LandingCopy = {
  ...
  heroDesc: "Residentes de Massachusetts perdem milhares em benefícios anuais porque o sistema é muito complexo. HealthCompass MA verifica mais de 11 programas de uma vez e guia você em cada solicitação — de graça.",
  heroTags: ["Gratuito", "11+ programas", "6 idiomas", "Mensagens de voz", "~15 min para solicitar"],
  ...
  previewResult: "🎉 4 programas encontrados — benefícios que valem milhares por ano",
  ...
  problemItems: [
    ...
    { title: "Os benefícios escorregam pelas rachaduras", body: "Famílias elegíveis muitas vezes se qualificam para vários programas que valem milhares de dólares por ano — mas muitas nunca os recebem, não porque não se qualificam, mas porque nunca souberam que podiam solicitar." },
    { title: "Foi negado injustamente? A maioria não recorre", body: "Benefícios são negados ou cortados por erros de papelada, prazos perdidos ou regras mal aplicadas — mas recorrer parece um labirinto jurídico, então a maioria aceita a negação em vez de contestá-la." },
  ],
  howLabel: "Como Funciona",
  howTitle: "Da confusão à cobertura em 5 etapas",
  howDesc: "Eliminamos as suposições em cada etapa — desde descobrir para o que você se qualifica, até enviar solicitações, acompanhar resultados e recorrer de negativas.",
  steps: [
    ...
    { title: "Foi negado? Recorra em minutos", body: "Se um programa negar, cole o aviso de negativa — nossa IA redige uma carta de recurso citada, baseada em regulamentos reais do MassHealth." },
  ],
  whyLabel: "Por Que HealthCompass MA",
  whyTitle: "Criado para famílias reais de Massachusetts — agora com mais formas de receber ajuda",
  whyDesc: "As melhorias recentes adicionam chat ao vivo com assistentes sociais, mensagens de voz, tradução automática, suporte de recurso com IA, um glossário de benefícios em linguagem simples e uma linha do tempo completa do seu histórico de seguro — tudo criado para ajudar residentes elegíveis a obter os benefícios a que têm direito com menos atrito.",
  featureItems: [
    { title: "Motor de Elegibilidade com IA", body: "Verifique seu perfil contra 11+ programas estaduais e federais em segundos — sem papelada." },
    ...
    { title: "Glossário de Benefícios", body: "Toque em qualquer termo confuso — MAGI, spend-down, redeterminação — para uma definição em linguagem simples no seu idioma." },
    { title: "Linha do Tempo do Histórico de Seguro", body: "Veja todo o seu histórico de cobertura em um só lugar, com explicações claras de por que seu plano mudou de ano para ano." },
  ],
  statLabels: ["Programas de benefícios verificados", "Idiomas suportados", "Tempo médio para solicitar", "Residentes de MA provavelmente perdendo SNAP"],
  ...
  ctaDesc: "Leva 15 minutos. É completamente gratuito. Famílias elegíveis podem se qualificar para vários programas que valem milhares de dólares por ano, dependendo do tamanho da família e da renda.",
...
const VI: LandingCopy = {
  ...
  heroDesc: "Cư dân Massachusetts bỏ lỡ hàng nghìn đô la phúc lợi hàng năm vì hệ thống quá phức tạp. HealthCompass MA kiểm tra 11+ chương trình cùng một lúc và hướng dẫn bạn qua từng đơn xin — miễn phí.",
  heroTags: ["Miễn phí", "11+ chương trình", "6 ngôn ngữ", "Tin nhắn thoại", "~15 phút để nộp đơn"],
  ...
  previewResult: "🎉 Tìm thấy 4 chương trình — phúc lợi trị giá hàng nghìn đô la mỗi năm",
  ...
  problemItems: [
    ...
    { title: "Phúc lợi lọt qua kẽ hở", body: "Các gia đình đủ điều kiện thường đủ tiêu chuẩn cho nhiều chương trình trị giá hàng nghìn đô la mỗi năm — nhưng nhiều gia đình không bao giờ nhận được, không phải vì họ không đủ điều kiện, mà vì họ không biết có thể nộp đơn." },
    { title: "Bị từ chối oan? Hầu hết mọi người không kháng cáo", body: "Phúc lợi bị từ chối hoặc cắt vì lỗi giấy tờ, trễ hạn, hoặc áp dụng sai quy định — nhưng kháng cáo giống như một mê cung pháp lý, nên hầu hết mọi người chấp nhận từ chối thay vì phản đối." },
  ],
  howLabel: "Cách Thức Hoạt Động",
  howTitle: "Từ bối rối đến được bảo hiểm trong 5 bước",
  howDesc: "Chúng tôi loại bỏ sự đoán mò ở mọi giai đoạn — từ việc tìm hiểu bạn đủ điều kiện gì, đến nộp đơn, theo dõi kết quả, và kháng cáo khi bị từ chối.",
  steps: [
    ...
    { title: "Bị từ chối? Kháng cáo trong vài phút", body: "Nếu một chương trình từ chối bạn, dán thông báo từ chối vào — AI của chúng tôi soạn thư kháng cáo có trích dẫn, dựa trên quy định thực tế của MassHealth." },
  ],
  whyLabel: "Tại Sao HealthCompass MA",
  whyTitle: "Được xây dựng cho các gia đình Massachusetts thực sự — nay có thêm nhiều cách để nhận trợ giúp",
  whyDesc: "Các nâng cấp gần đây bổ sung trò chuyện trực tiếp với nhân viên xã hội, tin nhắn thoại, dịch tự động, hỗ trợ kháng nghị bằng AI, bảng thuật ngữ phúc lợi bằng ngôn ngữ đơn giản, và dòng thời gian lịch sử bảo hiểm đầy đủ — tất cả nhằm giúp cư dân đủ điều kiện nhận các quyền lợi họ được hưởng với ít trở ngại hơn.",
  featureItems: [
    { title: "Công Cụ Kiểm Tra Tư Cách AI", body: "Kiểm tra hồ sơ của bạn với 11+ chương trình tiểu bang và liên bang trong vài giây — không cần giấy tờ." },
    ...
    { title: "Bảng Thuật Ngữ Phúc Lợi", body: "Chạm vào bất kỳ thuật ngữ khó hiểu nào — MAGI, spend-down, tái xác định — để xem định nghĩa bằng ngôn ngữ đơn giản, bằng ngôn ngữ của riêng bạn." },
    { title: "Dòng Thời Gian Lịch Sử Bảo Hiểm", body: "Xem toàn bộ lịch sử bảo hiểm của bạn trong một nơi, kèm giải thích rõ ràng vì sao gói bảo hiểm của bạn thay đổi qua từng năm." },
  ],
  statLabels: ["Chương trình phúc lợi được kiểm tra", "Ngôn ngữ được hỗ trợ", "Thời gian trung bình để nộp đơn", "Cư dân MA có thể đang bỏ lỡ SNAP"],
  ...
  ctaDesc: "Mất 15 phút. Hoàn toàn miễn phí. Các gia đình đủ điều kiện có thể đủ tiêu chuẩn cho nhiều chương trình trị giá hàng nghìn đô la mỗi năm, tùy thuộc vào quy mô hộ gia đình và thu nhập.",
