...
const EN: LandingCopy = {
  ...
  whyDesc: "Recent upgrades add live social worker chat, voice messaging, automatic translation, and AI appeal support — all designed to help eligible residents get the benefits they're entitled to with less friction.",
  featureItems: [
...
const ES: LandingCopy = {
  ...
  whyDesc: "Las mejoras recientes agregan chat en vivo con trabajadores sociales, mensajes de voz, traducción automática y apoyo con apelaciones mediante IA — todo diseñado para ayudar a los residentes elegibles a obtener los beneficios que les corresponden con menos fricción.",
  featureItems: [
...
const ZH_CN: LandingCopy = {
  ...
  whyDesc: "最近的升级增加了真人社工聊天、语音消息、自动翻译和 AI 上诉支持 — 全部都是为了帮助符合条件的居民更顺利地获得应得的福利。",
  featureItems: [
...
const HT: LandingCopy = {
  ...
  whyDesc: "Dènye amelyorasyon yo ajoute chat an dirèk ak travayè sosyal, mesaj vwa, tradiksyon otomatik, ak sipò apèl ak IA — tout sa fèt pou ede rezidan ki kalifye jwenn avantaj yo gen dwa jwenn ak mwens difikilte.",
  featureItems: [
...
const PT_BR: LandingCopy = {
  ...
  whyDesc: "As melhorias recentes adicionam chat ao vivo com assistentes sociais, mensagens de voz, tradução automática e suporte de apelação com IA — tudo criado para ajudar residentes elegíveis a obter os benefícios a que têm direito com menos atrito.",
  featureItems: [
...
const VI: LandingCopy = {
  ...
  whyDesc: "Các nâng cấp gần đây bổ sung trò chuyện trực tiếp với nhân viên xã hội, tin nhắn thoại, dịch tự động và hỗ trợ kháng nghị bằng AI — tất cả nhằm giúp cư dân đủ điều kiện nhận các quyền lợi họ được hưởng với ít trở ngại hơn.",
  featureItems: [
