...
const COPY: Record<SupportedLanguage, PrescreenerCopy> = {
  en: {
    ...
    supportHours: "for personalized assistance.",
    ...
    callMassHealth: "Email support at",
    fpl100: "100% FPL",
  ...
  ht: {
    ...
    supportHours: "pou asistans pèsonalize.",
    ...
    callMassHealth: "Voye imèl bay sipò nan",
    fpl100: "100% FPL",
    fpl138: "138% FPL (Medicaid)",
    fpl200: "200% FPL",
    fpl300: "300% FPL",
  ...
  "pt-BR": {
    ...
    supportHours: "para assistência personalizada.",
    ...
    callMassHealth: "Envie email ao suporte em",
    fpl100: "100% do FPL",
  ...
  es: {
    ...
    supportHours: "para asistencia personalizada.",
    ...
    callMassHealth: "Envíe un correo al soporte a",
    fpl100: "100% del FPL",
  ...
  vi: {
    ...
    supportHours: "để được hỗ trợ cá nhân.",
    ...
    callMassHealth: "Email bộ phận hỗ trợ tại",
    fpl100: "100% FPL",
    fpl138: "138% FPL (Medicaid)",
    fpl200: "200% FPL",
    fpl300: "300% FPL",
